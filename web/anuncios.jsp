                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fas fa-bell"></i> Crear Anuncio
                                    </div>
                                    <div class="card-body">
                                        <form action="ANUNCIOcontroller.do" method="post" class="row g-3">
                                            <div class="col-md-7">
                                                <label for="titulo" class="form-label">Titulo</label>
                                                <input type="text" class="form-control" id="titulo" name="txtAnuncioTitulo">
                                            </div>
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    <label for="fecha" class="form-label">Fecha</label>
                                                    <input type="date" class="form-control" id="fecha" name="txtAnuncioFecha">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="comunicado" class="form-label">Comunicado</label>
                                                <textarea class="form-control" id="comunicado" rows="4" name="txtAnuncioComunicado"></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Subir imagen (opcional)</label>
                                                <input class="form-control" type="file" id="formFile">
                                            </div>
                                            <div class="col-12">
                                                <center><button class="btn btn-danger" type="submit" name="accionAnuncio" value="insertar">Publicar</button></center>
                                            </div>
                                        </form>
                                    </div>
                                </div>   
