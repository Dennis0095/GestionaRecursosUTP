            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Estimado usuario, en esta sección usted puede registrar o revisar las incidencias ocurridas con los equipos informáticos que pertenecen a su departamento de trabajo, el cual usted lidera.
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fas fa-pen"></i> Registrar Evento
                                    </div>
                                    <div class="card-body">
                                        <form action="INCIDENCIAcontroller.do" method="post" class="row g-3">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="fecha" class="form-label">Fecha</label>
                                                    <input type="date" class="form-control" id="fecha" name="txtFecha">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="usuario" class="form-label">Usuario</label>
                                                <input type="text" class="form-control" id="usuario" name="txtUser">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" id="descripcion" rows="4" name="txtDescripcion"></textarea>
                                            </div>
                                            <div class="col-12">
                                                <button class="btn btn-danger" type="submit" name="accionEvento" value="insertar">Registrar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>   
                            ...
                            <div class="col-sm-8">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fas fa-search"></i> Buscar evento
                                    </div>
                                    <div class="card-body">
                                        <form action="INCIDENCIAcontroller.do" method="post" class="row g-3">
                                            <div class="col-md-3">
                                                <div class="input-group mb-3">
                                                    <input type="date" class="form-control" placeholder="" name="txtBuscarFecha">
                                                    <button class="btn btn-success" type="submit" id="" name="accionEvento" value="BuscarFecha">Buscar</button>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Usuario o Equipo" name="txtBuscarUE">
                                                    <button class="btn btn-success" type="submit" name="accionEvento" value="BuscarEvento">Buscar</button>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon3">Coincidencias:<c:forEach var="evento" items="${cantidad}"> ${evento.getContar()}</c:forEach></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon3">Búsqueda:</span>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    <c:forEach var="evento" items="${ocurrencia}">
                                                    <tr class="align-middle">
                                                        <td>${evento.getFecha()}</td> 
                                                        <td>${evento.getUsuario()}</td>
                                                        <td>${evento.getNombreHost()}</td>
